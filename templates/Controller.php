...
class Controller
{
    ...
    {
        include (dirname(dirname(__FILE__)) . "/componentes/comp.Calendario.php");
    }
    ...
    {
        include (dirname(dirname(__FILE__)) . "/componentes/comp.Msg.php");
    }
    ...
    {
        include (dirname(dirname(__FILE__)) . "/componentes/comp.ListaUf.php");
    }
    ...
    {
        include (dirname(dirname(__FILE__)) . "/componentes/comp.Paginacao.php");
    }
}