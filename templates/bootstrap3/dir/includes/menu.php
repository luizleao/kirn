<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			</a> <a class="brand" href="#">Blog</a>
			<div class="btn-group pull-right">
				<a class="btn dropdown-toggle" data-toggle="dropdown" href="#"> <i
					class="icon-user"></i>Usuário: <?=$_SESSION['usuarioAtual']->login?><span
					class="caret"></span>
				</a>
			...
			<div class="nav-collapse">
				<ul class="nav">
					<li class="active"><a href="principal.php"><i
...
foreach ($_SESSION['aMenu'] as $nomeSistema => $aModuloMenu) {
    ?>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"><?=$nomeSistema?> <b class="caret"></b></a>
						<ul class="dropdown-menu">
<?php
