								...
								<div class="card-content">
									...
									<div class="row">
										<div class="input-field col s3">
											<label for="host">Host</label> <input type="text" id="host" name="host" value="" />
										</div>
										<div class="input-field col s3">
										...
										<div class="input-field col s2">
											<button id="btnConectar" type="submit" class="btn btn-small btn-flat">
    ...
    foreach ($aXML as $xml) {
        ?>
    									<tr>
											<td><?=ucfirst($xml)?></td>
											<td>
												<a class="btn btn-small btn-flat" href="xml/<?=$xml?>.xml?" target="_blank">
													<i class="material-icons">insert_link</i>
												</a>
											</td>
											<td>
												<a href="?acao=download&app=<?=$xml?>" class="btn btn-small btn-flat" target="_blank">
...
<?php
        if (file_exists("geradas/$xml")) {
            ?>
											<td>
												<a class="btn btn-small btn-flat" href="geradas/<?=$xml?>/" target="_blank">
													<i class="material-icons tiny">open_in_browser</i>
												</a>
											</td>
											<td>
												<a href="?acao=download&app=<?=$xml?>" class="btn btn-small btn-flat" target="_blank">
													<i class="material-icons tiny">cloud_download</i>
												</a>
											</td>
<?php
        }
        ?>
    										<td>
    											<a id="btnExcluirXML" data-xml="<?=$xml?>" class="btn btn-small btn-flat" href="#">
